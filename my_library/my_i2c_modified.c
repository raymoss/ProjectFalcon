...
//     return (a-2);
  ...
  I2C_Send7bitAddress(I2Ci, temp , I2C_Direction_Receiver);
  //usart_printf(USART1,"device address: %x",temp);
  if(num==1){
    ...
    while(I2C_GetFlagStatus(I2Ci,I2C_FLAG_ADDR)!=SET){
     ms_delay(1);
          if((timeout--)==0){
            ...
            flag2 = I2Ci->SR2;
            usart_printf(USARTx,"Flag1:%04x \n\r Flag2:%04x\n\r",flag1,flag2);
            usart_printf(USARTx,"Failing at reading 2 bytes stage2.1\n\r");
            return -1;
          }}
    I2C_AcknowledgeConfig(I2Ci, DISABLE);
    I2C_NACKPositionConfig(I2Ci, I2C_NACKPosition_Next);
    flag1 = I2Ci->SR1;        //Clearing ADDR flag
    flag2 = I2Ci->SR2;
    timeout = I2C_TIMEOUT_MAX; 
    while(I2C_GetFlagStatus(I2Ci,I2C_FLAG_BTF)!=SET){
      ms_delay(1);
          if((timeout--)==0){
            ...
            flag2 = I2Ci->SR2;
            usart_printf(USARTx,"Flag1:%04x \n\r Flag2:%04x\n\r",flag1,flag2);
            usart_printf(USARTx,"Failing at reading 2 bytes stage2.2\n\r");
            return -1;
          }}
